...
// 四维维度渐进路由算法 (4D Dimension-Order Routing: X -> Y -> Z -> W)
...
int main (int argc, char *argv[])
{
  ...
  uint32_t uniformFlows = 200000; // 20万个包
  ...
  // 【4D 能耗模型计算】
  // =================================================================
  double P_static_node = 2000.0;   // 静态功率：2000 W
  double P_full_load   = 8000.0;   // 满载功率：8000 W
  double P_compute     = P_full_load - P_static_node; // 计算额外暴发功率：6000 W
  double E_dynamic_bit = 10e-12;   // 10 pJ/bit
